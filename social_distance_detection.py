...
# else:
#     #cap = cv2.VideoCapture('rtsp://admin:admin123@10.0.1.200:10080')
#     # cap = cv2.VideoCapture('/home/glueck/Documents/GlueckTech/sample.mp4')
cap = cv2.VideoCapture('/home/mlmachine/Documents/distance2.jpg')
# cap = cv2.VideoCapture('/home/mlmachine/Documents/projects/Social-Distance-Detection-using-OpenCV-master/1599034163774_Test_GLKCEBOX002_4.jpg')
...
while cap.isOpened():
    ...
    for i in range(detections.shape[2]):
        ...
        if confidence > confidences:
            ...
            if class_id == 15.00:
                ...
                #frame = cv2.line(frame, (startX, startY), (endX, endY), (0,0,255), 4)
                ...
                x_cm = int(round(x_mid_cm))
                print("x_cm",x_cm)
                y_cm = int(round(y_mid_cm))
                print("y_cm",y_cm)
                print("pos_dict",pos_dict[i])
                #frame = cv2.line(frame, (x,y), (y,x), (255,0,0), 4)
                # cv2.line(frame,(0,h+1),(w,h+1),(0,255,0),2)
    ...
    for i in pos_dict.keys():
        if i in close_objects:
            ...
            #frame = cv2.line(frame, (x,y), (y,x), (0,0,255), 4)
